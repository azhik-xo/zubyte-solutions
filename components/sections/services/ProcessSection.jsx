...
/**
 * 4-Phase Expandable Delivery Methodology Section fetching live from MongoDB via CompanyContext
 */
export default function ProcessSection() {
  const { processSteps, isLoading } = useCompany();
  ...
  if (!isLoading && (!processSteps || processSteps.length === 0)) {
    return null;
  }
                  ...
                  >
                    ...
                    {isOpen && (
                      <div className="bg-[#faf9f5] border-t border-[var(--border)] p-6 animate-in fade-in duration-200">
                        ...
                        {stepItem.extras && stepItem.extras.length > 0 && (
