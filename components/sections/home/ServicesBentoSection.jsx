...
/**
 * Services Snapshot Bento Grid Section on Homepage
 */
    ...
    <section className="bg-[var(--background)] py-24 sm:py-28">
      <Container size="default">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-4">
          ...
          <Link
            href="/services"
            className="md:col-span-7 rounded-3xl p-8 sm:p-10 flex flex-col justify-between min-h-[280px] relative overflow-hidden group transition-all duration-300 border border-white/10 hover:border-white/25 hover:shadow-xl"
          ...
          <Link
            href="/services"
            className="md:col-span-5 rounded-3xl p-8 sm:p-10 flex flex-col justify-between min-h-[280px] group transition-all duration-300 shadow-md hover:shadow-xl"
          ...
          {SERVICES.slice(2, 5).map((service, idx) => (
            <Link
              key={service.group}
              href="/services"
              className="md:col-span-4 rounded-3xl p-7 sm:p-8 flex flex-col justify-between min-h-[240px] group transition-all duration-300 border border-white/10 hover:border-white/25 hover:shadow-lg"
              style={{
