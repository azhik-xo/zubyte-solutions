    ...
    <section className="bg-[var(--background)] py-20 sm:py-24">
      <Container size="default">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          {/* Mission Card — Col 7 */}
          <div className="md:col-span-7 bg-[#1b1b1b] rounded-3xl p-8 sm:p-12 text-white flex flex-col justify-between min-h-[380px] shadow-xl border border-white/10">
            <div>
          ...
          <div className="md:col-span-5 flex flex-col gap-6">
            {/* Vision Image Card */}
            <div className="relative rounded-3xl overflow-hidden flex-1 min-h-[220px] shadow-lg">
              <img
